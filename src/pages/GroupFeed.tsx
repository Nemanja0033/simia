...
import GroupFeedComponent from "../components/GroupFeedComponent";
...
const GroupFeed = () => {
    ...
    const openRequestModal = async (name: string) => {
      await fetchMemberRequests(name);
            ...
            <div className="w-full flex-row mt-20">
                <div className="flex w-full justify-center">
                    <nav className="fixed top-[70px] backdrop-blur-sm bg-transparent md:w-1/2 w-full flex justify-around h-[50px] rounded-md shadow-md gap-4 items-center">
                        ...
                        <button className="btn btn-xs btn-neutral border-none bg-primary text-white hover:text:primary" onClick={() => openRequestModal(f.name)}><UserRoundPlus /></button>
